...
return [
    ...
    'generic' => [
        ...
        'auto_increment'         => 'Số tự tăng',
        'browse'                 => 'Tìm',
        'builder'                => 'Người dựng',
        'bulk_delete'            => 'Bulk Delete',
        'bulk_delete_confirm'    => 'Vâng, Xóa ngay',
        ...
        'delete_question'        => 'Bạn có chắc là xóa chứ?',
        'delete_this_confirm'    => 'Vâng, xóa nó đi.',
        ...
        'submit'                 => 'Submit',
        'successfully_added_new' => 'Tạo mới thành công',
    ...
    'login' => [
        'loggingin'    => 'Đăng nhập',
        'signin_below' => 'Đăng nhập bên dưới:',
        'welcome'      => 'Chào mừng đến trang quản trị Smart Machine',
    ],

    'profile' => [
        'avatar'        => 'Hình đại diện',
        'edit'          => 'Cật nhật thông tin cá nhân',
        'edit_user'     => 'Edit User',
        'password'      => 'Password',
        'password_hint' => 'Leave empty to keep the same',
        'role'          => 'Phân quyền',
        'user_role'     => 'Quyền hạn của người dùng',
    ],
    ...
    'media' => [
        'add_new_folder'         => 'Tạo mới thư mục',
        'audio_support'          => 'Trình duyệt đang sử dụng ko hổ trợ phát âm thanh.',
        'create_new_folder'      => 'Tạo mới thư mục',
        'delete_folder_question' => 'Xóa thư mục là xóa tất cả những gì bên trong thư mục đó.',
        'destination_folder'     => 'Thư mục cuối',
        'drag_drop_info'         => 'Kéo thả hình ảnh/video vào đây để tải lên trang web',
