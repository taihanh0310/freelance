                    ...
                    <div class="aa-product-area">
                        <div class="aa-product-inner">
                            ...
                            <ul class="nav nav-tabs aa-products-tab">
                                <li class="active"><a href="#men" data-toggle="tab">SX Cửa nhôm</a></li>
                                <li><a href="#women" data-toggle="tab">SX cửa nhựa</a></li>
                                <li><a href="#sports" data-toggle="tab">LK Thay thế</a></li>
                                <li><a href="#electronics" data-toggle="tab">Máy cầm tay</a></li>
                            </ul>
                            <!-- Tab panes -->
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="aa-popular-category-area">
                        <!-- start prduct navigation -->
                        <ul class="nav nav-tabs aa-products-tab">
                            <li class="active"><a href="#popular" data-toggle="tab">Sản phẩm được mua nhiều nhất</a></li>
                            <li><a href="#featured" data-toggle="tab">Sản phẩm đặc biệt</a></li>
