...
class Payment extends React.Component{
    _onChangeField(field, value){
        ...
        if(field === 'discount_rate'){
            var total_money_before_discount = this.props.khachLeTraHangForm.values.total_money_before_discount;
            var delivery_total_money = this.props.khachLeTraHangForm.values.delivery_total_money;
