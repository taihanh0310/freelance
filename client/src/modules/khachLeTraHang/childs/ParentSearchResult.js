...
class ParentSearchResult extends React.Component {
    ...
    _onClickRow(khachLeTraHang, key){
        this.props.chooseSelectedDetail(khachLeTraHang);
                ...
                <div className="portlet box green">
                    ...
                    <div className="table-scrollable">
                        <table className="table fixed-header table-bordered" id="search_bill_result_list">
                            ...
                            {
                                (this.props.khachLeTraHangs === 'undefined' || this.props.khachLeTraHangs.list === 'undefined' || this.props.khachLeTraHangs.list.length == 0)
                                ?
                                (    <tr>
                                ...
                                :
                                (
                                    this.props.khachLeTraHangs.list.map((khachLeTraHang, key) => {
                                        const selected = (this.props.khachLeTraHangs.selectedDetail.id === khachLeTraHang.id) ? 'row-active': '';
                                        return (
                                            <tr key={key} className={selected} onClick={this._onClickRow.bind(this, khachLeTraHang, key)}>
                                                <td>{khachLeTraHang.khach_le_tra_hang_code}</td>
                                                <td>{Helper.formatStringToDate(khachLeTraHang.return_date)}</td>
                                            </tr>
                                        );
                                    })
                                )
