...
class XuatChuyenKhoPayment extends React.Component{
    ...
    _onChangeField(field, value){
        ...
        if(field === 'discount_rate'){
            ...
            var delivery_total_money = this.props.xuatChuyenKhoForm.values.delivery_total_money;
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-sm-4">
                                            ...
                                            <div className="input-group">
                                                ...
                                                <input type="number" className="text-right form-control" ref="total_discount_money" readOnly value={Numeral(form.total_discount_money).format('0,0')}/>
                                            </div>
                                        </div>
                                        <div className="col-sm-4">
                                            <div className="form-group">
...
module.exports = ReactRedux.connect(mapStateToProps, mapDispatchToProps)(XuatChuyenKhoPayment);