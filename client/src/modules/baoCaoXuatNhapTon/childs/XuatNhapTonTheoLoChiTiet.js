...
class XuatNhapTonTheoLoChiTiet extends React.Component {
    ...
    render() {
        return (
                <div className="portlet box green">
                    <div className="portlet-title">
                        <div className="caption">
                            Danh sách thuốc xuất nhập chi tiết theo lô
                        </div>
                    </div>
                ...
                module.exports = ReactRedux.connect(mapStateToProps, mapDispatchToProps)(XuatNhapTonTheoLoChiTiet);
