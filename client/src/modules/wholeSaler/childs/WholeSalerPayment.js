...
class WholeSalerPayment extends React.Component{
    ...
    _onChangeField(field, value){
        ...
        if(field === 'discount_rate'){
            ...
            var delivery_total_money = this.props.wholeSalerForm.values.delivery_total_money;
                            ...
                            <div className="col-sm-3">
                                <div className="form-group">
                                    ...
                                    <div className="input-group">
                                        <input type="number" className="form-control" min="0" max="100" ref="discount_rate" value = {form.discount_rate} onChange={event => this._onChangeField('discount_rate', event.target.value)}/>
...
module.exports = ReactRedux.connect(mapStateToProps, mapDispatchToProps)(WholeSalerPayment);