...
const Reducer = (state = INITIAL_STATE, action) => {
	switch(action.type){
		...
		case WHOLE_SALER_CLEAR_SELECTED_DETAIL:
			return {...state, selectedDetail: {}};
		case WHOLE_SALER_CHANGE_LIST_CHILD:
