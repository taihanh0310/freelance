...
class MedicineExpireDateButtons extends React.Component{
    

    _onPrintReview(){
            let values = this.props.medicineExpireForm.values;
            axios.post(`${Config.API_URL}medicine/thuocSapHetHanSuDungPDFReport`, {values}, {
            ...
            .then((response) => {
                ...
                const fileName = `thuoc_sap_het_han_su_dung_${date}.pdf`;
...
module.exports = ReactRedux.connect(mapStateToProps, mapDispatchToProps)(MedicineExpireDateButtons);