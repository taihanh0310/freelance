                            ...
                            <table className="table fixed-header table-bordered" id="search_bill_result_list">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Nhà thuốc</th>
                                        <th>Hạn sử dụng</th>
                                        <th style={{color:this.props.medicineExpireForm.values.color_warning}}>Ngày hiệu lực</th>
                                        <th>Tồn hiện tại</th>
                                        <th>Nhà sản xuất</th>
                                        <th>Nhà cung cấp</th>
                                    </tr>
                                        ...
                                        this.props.medicineExpires.list.map((medicineExpire, key) => {
                                            return (
                                                <tr key={key}>
                                                    ...
                                                    <td>{Helper.formatStringToDate(medicineExpire.medicine_limited_date)}</td>
                                                    <td style={{color:this.props.medicineExpireForm.values.color_warning}} className="text-right">{medicineExpire.ngay_hieu_luc}</td>
                                                    <td className="text-right">{Numeral(medicineExpire.so_luong_ton).format('0,0')}</td>
