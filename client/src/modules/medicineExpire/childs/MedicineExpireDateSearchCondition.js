...
class MedicineExpireDateSearchCondition extends React.Component{
    ...
    _loadWarning(){
        axios.get(`${Config.API_URL}pharma-system-warning/2`)
        .then(response => {
    ...
    _loadList(value){
        ...
        this.props.loadLimitDateList(value)
        .then(() => {
...
module.exports = ReactRedux.connect(mapStateToProps, mapDispatchToProps)(MedicineExpireDateSearchCondition);