...
const Reducer = (state = INITIAL_STATE, action) => {
	switch(action.type){
		...
		case STORAGE_CONDITION_UPDATE_LIST:
		...
		case STORAGE_CONDITION_CHANGE_SEARCH_LIST:
			return {...state, search: {...state.search, [action.payload.field]: action.payload.value}};
		case STORAGE_CONDITION_FILTER_LIST:
