import {
	STORAGE_POSITION_FORM_CHANGE,
	STORAGE_POSITION_FORM_VALIDATION,
	STORAGE_POSITION_FORM_CLEAR,
	STORAGE_POSITION_FORM_CHANGE_MODE
} from '../types';
...
export const formChange = (field, value) => {
	return {
		type: STORAGE_POSITION_FORM_CHANGE,
		payload: {field, value}
	};
};
...
export const formValidation = (field, value) => {
	return {
		type: STORAGE_POSITION_FORM_VALIDATION,
		payload: {field, value}
	};
};
...
export const formClear = () => {
	return {
		type: STORAGE_POSITION_FORM_CLEAR,
		payload: false
	};
};
...
export const formChangeMode = (mode) => {
	return {
		type: STORAGE_POSITION_FORM_CHANGE_MODE,
		payload: mode
	};
};
...
export const formAdd = (values) => {
	return (dispatch) => {
		return new Promise((resolve, reject) => {
			setTimeout(() => {
				axios.post(`${Config.API_URL}stogare-position`, values)
				.then(response => {
...
export const formDelete = (id) => {
	return (dispatch) => {
		return new Promise((resolve, reject) => {
			setTimeout(() => {
				axios.delete(`${Config.API_URL}stogare-position/${id}`)
				.then(response => {
...
export const formEdit = (values) => {
	return (dispatch) => {
		return new Promise((resolve, reject) => {
			setTimeout(() => {
				axios.put(`${Config.API_URL}stogare-position/${values.id}`, values)
				.then(response => {
