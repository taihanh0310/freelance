...
export const formChange = (field, value) => {
	return {
		type: INTERNAL_STOCK_DELIVERY_FORM_CHANGE,
		payload: {field, value}
	};
};
...
export const formValidation = (field, value) => {
	return {
		type: INTERNAL_STOCK_DELIVERY_FORM_VALIDATION,
		payload: {field, value}
	};
};
...
export const formClear = () => {
	return {
		type: INTERNAL_STOCK_DELIVERY_FORM_CLEAR,
		payload: false
	};
};
...
export const formChangeMode = (mode) => {
	return {
		type: INTERNAL_STOCK_DELIVERY_CHANGE_MODE,
		payload: mode
	};
};
