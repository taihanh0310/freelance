...
export const formChange = (field, value) => {
	return {
		type: MEDICINE_GROUP_FORM_CHANGE,
		payload: {field, value}
	};
};
...
export const formValidation = (field, value) => {
	return {
		type: MEDICINE_GROUP_FORM_VALIDATION,
		payload: {field, value}
	};
};
...
export const formClear = () => {
	return {
		type: MEDICINE_GROUP_FORM_CLEAR,
		payload: false
	};
};
...
export const formChangeMode = (mode) => {
	return {
		type: MEDICINE_GROUP_FORM_CHANGE_MODE,
		payload: mode
	};
};
...
export const formAdd = (values) => {
	return (dispatch) => {
		return new Promise((resolve, reject) => {
			setTimeout(() => {
				axios.post(`${Config.API_URL}medicine-group`, values)
				.then(response => {
...
export const formDelete = (id) => {
	return (dispatch) => {
		return new Promise((resolve, reject) => {
			setTimeout(() => {
				axios.delete(`${Config.API_URL}medicine-group/${id}`)
				.then(response => {
...
export const formEdit = (values) => {
	return (dispatch) => {
		return new Promise((resolve, reject) => {
			setTimeout(() => {
				axios.put(`${Config.API_URL}medicine-group/${values.id}`, values)
				.then(response => {
