...
export const formChangeMode = (mode) => {
	return {
		type: PRODUCER_FORM_CHANGE_MODE,
		payload: mode
	};
};
...
export const formAdd = (values) => {
	return (dispatch) => {
		return new Promise((resolve, reject) => {
			setTimeout(() => {
				axios.post(`${Config.API_URL}producer`, values)
				.then(response => {
...
export const formDelete = (id) => {
	return (dispatch) => {
		return new Promise((resolve, reject) => {
			setTimeout(() => {
				axios.delete(`${Config.API_URL}producer/${id}`)
				.then(response => {
...
export const formEdit = (values) => {
	return (dispatch) => {
		return new Promise((resolve, reject) => {
			setTimeout(() => {
				axios.put(`${Config.API_URL}producer/${values.id}`, values)
				.then(response => {
