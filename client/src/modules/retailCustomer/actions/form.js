...
export const formChange = (field, value) => {
	return {
		type: RETAIL_CUSTOMER_FORM_CHANGE,
		payload: {field, value}
	};
};
...
export const formValidation = (field, value) => {
	return {
		type: RETAIL_CUSTOMER_FORM_VALIDATION,
		payload: {field, value}
	};
};
...
export const formClear = () => {
	return {
		type: RETAIL_CUSTOMER_FORM_CLEAR,
		payload: false
	};
};
...
export const formChangeMode = (mode) => {
	return {
		type: RETAIL_CUSTOMER_FORM_CHANGE_MODE,
		payload: mode
	};
};
...
export const formAdd = (values) => {
	return (dispatch) => {
		return new Promise((resolve, reject) => {
			setTimeout(() => {
				axios.post(`${Config.API_URL}retail-customers`, values)
				.then(response => {
...
export const formDelete = (id) => {
	return (dispatch) => {
		return new Promise((resolve, reject) => {
			setTimeout(() => {
				axios.delete(`${Config.API_URL}retail-customers/${id}`)
				.then(response => {
...
export const formEdit = (values) => {
	return (dispatch) => {
		return new Promise((resolve, reject) => {
			setTimeout(() => {
				axios.put(`${Config.API_URL}retail-customers/${values.id}`, values)
				.then(response => {
