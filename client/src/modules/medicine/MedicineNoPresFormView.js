...
class MedicineNoPresFormView extends React.Component{
	constructor(){
		super();
		this.state = {
			confirm: false,
						...
						<div className="portlet box green">
			  				<div className="portlet-title">
			  					<div className="caption">
			  						<Translate value="medicine.nameNoPres"/>
			  					</div>
			  				</div>
...
module.exports = ReactRedux.connect(mapStateToProps, mapDispatchToProps)(MedicineNoPresFormView);