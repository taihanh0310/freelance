...
import * as XuatTraHangNCCFormActions from 'modules/xuatTraHangNCC/actions/list';
...
class Payment extends React.Component{
    _onChangeField(field, value){
        ...
        if(field === 'discount_rate'){
            var total_money_before_discount = this.props.xuatTraHangNCCForm.values.total_money_before_discount;
            var product_total_money = this.props.xuatTraHangNCCForm.values.product_total_money;
