...
import {loadCustomerList as supplierLoadList} from 'modules/supplier/actions/list'; // Danh sach nha cung cap

class PhieuThuParentForm extends React.Component{
    ...
    render(){
    	const form = this.props.phieuThuForm.values;
    	const formErrors = this.props.phieuThuForm.errors;
        return (
                	...
                	<div className="form-horizontal">
                		<div className="form-body">
                			<div className="row">
                				...
                				<div className="col-sm-3">
	                				<div className="form-group">
	                					<label className="control-label col-md-4">Người thu</label>
	                					<div className="col-md-8">
                			...
                			<div className="row">
                				<div className="col-sm-3">
	                				<div className={formErrors.date_output?'form-group has-error':'form-group'}>
                                        <label className="control-label col-md-4">Ngày Thu</label>
                                        <div className="col-md-8">
...
module.exports = ReactRedux.connect(mapStateToProps, mapDispatchToProps)(PhieuThuParentForm);
