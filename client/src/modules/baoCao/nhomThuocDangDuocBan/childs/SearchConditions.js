                            ...
                            <div className="row">
                                <div className="col-sm-3">
                                    <div className="form-group">
                                        ...
                                        <select className="form-control" value={this.props.nhomThuocDangDuocBans.search.from_drug_store_id} onChange={event => this._onSearch('from_drug_store_id', event.target.value)}>
                                        {
