...
class RetailerButtons extends React.Component{
        constructor(){
            super();
            this.state = {
        ...
        _onValidationSubmit(){
            ...
            } = this.props.retailerForm.values;
            ...
            return new Promise((resolve, reject) => {
                setTimeout(() => {
                    const errors = this.props.retailerForm.errors;
                    let valid = true;
        ...
        _onSave(){
            ...
            const data = this.props.retailerForm.values;
            // Get form data detail
            const details = this.props.retailers.listChild.list;

            switch(this.props.retailerForm.mode){
                case 'add':{
        ...
        _onDelete(){
            ...
            this.props.formDelete(this.props.retailers.selectedDetail.id)
            .then(() => {
        ...
        _onPrintReview(){
            let id = this.props.retailers.selectedDetail.id;
...
module.exports = ReactRedux.connect(mapStateToProps, mapDispatchToProps)(RetailerButtons);
