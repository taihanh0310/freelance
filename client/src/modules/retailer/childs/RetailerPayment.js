...
import RetailerChildSearchResult from 'modules/retailer/childs/RetailerChildSearchResult';
import {paymentTypeList as paymentList} from 'modules/paymentType/actions/list';

class RetailerPayment extends React.Component{
    ...
    _onChangeField(field, value){
        ...
        if(field === 'discount_rate'){
            ...
            var delivery_total_money = this.props.retailerForm.values.delivery_total_money;
...
module.exports = ReactRedux.connect(mapStateToProps, mapDispatchToProps)(RetailerPayment);
